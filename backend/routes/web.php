...
Route::get('/skordosen/ubah/{id}','SkorDosen@ubahNilai');
Route::get('/skordosen/create/{matkul}','SkorDosen@tambahNilai');
Route::get('/skordosen/{matkul}/{id}','SkorDosen@showMatkul');
Route::get('/skordosen/detailDosen/{id}/{sprint}','SkorDosen@show');
...
Route::get('/skorpoint/{id}/{idUser}','SkorPoint@show2');
Route::get('/skorpoint/detail/{id}/{sprint}','SkorPoint@show');
Route::get('/skorpoint/create','SkorPoint@tambahPoint');
